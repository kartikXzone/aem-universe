...
public final class LinkUtil {
    ...
    /**
     * Method is going to check whether passed url is of the current page
     * of parent of current page
     *
     * @param url, Resource, Request
     * @return
     */
    @SuppressWarnings("squid:S1850")
    public static boolean isCurrentPage(String url, Resource resource, SlingHttpServletRequest request) {

        boolean status = false;

        if ((resource != null) && (resource instanceof Resource)) {
            if (resource.getPath().contains(url)) {
                status = true;
            }
        } else {
            if (request != null) {
    ...
    /**
     * Method is going to check whether passed url is AEM internal or external,
     * if it is internal URL returned url will be suffixed by .html else will be
     * returned as it is.
     *
     * @param internalUrl
     * @return
    ...
    public static String getFormattedURL(String internalUrl) {

        String changedUrl = "";

        if (StringUtils.isNotBlank(internalUrl)) {
            if (isInternalLink(internalUrl, LinkUtil.DEFAULT_INTERNAL_LINK_PREFIX)) {
                changedUrl = addExtensionToLink(internalUrl, LinkUtil.DEFAULT_INTERNAL_LINK_PREFIX);
            } else {
                changedUrl = internalUrl;
            }
        }
     ...
     * internalLinkPrefix.
     *
     * @param link             <code>String</code> to be evaluated
     * @param resourceResolver <code>ResourceResolver</code> current request's resource
     *                         resolved
     * @param request          <code>HttpServletRequest</code> current HTTP request -
     ...
     */
    public static String createExternalizedLinkFromAuthoredProperty(String link, ResourceResolver resourceResolver, HttpServletRequest request) {
        return createExternalizedLinkFromAuthoredProperty(link, DEFAULT_INTERNAL_LINK_PREFIX, resourceResolver, request);
    }
     ...
     * printing out links in JS files or XML files.</li>
     * <li>
     * Ensures that link valid for use in href or src attributes by adding an
     * extension and network protocol if required.</li>
     * </ul>
     *
     * @param link               <code>String</code> to be evaluated
     * @param internalLinkPrefix <code>String</code> internal link prefix used to determine if
     ...
     */
    public static String createExternalizedLinkFromAuthoredProperty(String link, String internalLinkPrefix, ResourceResolver resourceResolver, HttpServletRequest request) {
     ...
     *
     * @param link <code>String</code> link to be checked.
     * @return String
     * @see LinkUtil.createValidLinkFromAuthoredProperty(String, String)
     */
     ...
     *
     * @param link               <code>String</code> link to be checked.
     * @param internalLinkPrefix <code>String</code> pattern that indicates if a link is
     *                           internal or not.
     * @return String
     ...
     *
     * @param link             <code>String</code> to be mapped
     * @param resourceResolver <code>ResourceResolver</code> current request's resource
     *                         resolved
     * @param request          <code>HttpServletRequest</code> current HTTP request -
     *                         optional but less capable resource mapping.
     * @return String mapped link based on JCR Resource Resolver rules.
     * @see LinkUtil.mapLink(String, String, ResourceResolver,
     * HttpServletRequest)
     ...
     * This method is intended to used in situations where the link checker will
     * not be run, for example when doing a 301 redirect server side, or
     * printing out links in JS files or XML files.
     * <p>
     * This method runs LinkUtils.isInternalLink(String) to determine if the
     * link is eligible for mapping.
     *
     * @param link               <code>String</code> to be evaluated
     * @param internalLinkPrefix <code>String</code> internal link prefix used to determine if
     ...
     * @see LinkUtils.isInternalLink(String, String)
     */
    public static String mapLink(String link, String internalLinkPrefix, ResourceResolver resourceResolver, HttpServletRequest request) {
     ...
     *
     * @param link               <code>String</code> to be evaluated
     * @param internalLinkPrefix <code>String</code> link is evaluated against
     * @return boolean
     */
    ...
    private static boolean linkNeedsExtension(String link, String internalLinkPrefix) {
        return EXTENSIONS_REQUIRED && isInternalLink(link, internalLinkPrefix) && !StringUtils.containsAny(link, new char[]{'.', '?'});
    }
     ...
     *
     * @param link link <code>String</code> to be evaluated
     * @return boolean
     */
